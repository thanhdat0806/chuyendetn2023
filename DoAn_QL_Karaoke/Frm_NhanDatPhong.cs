...
namespace DoAn_QL_Karaoke
{
    ...
    public partial class Frm_NhanDatPhong : Form
    {
          ...
          //  MessageBox.Show("" + TGHienTai.ToString("yyy/MM/dd"));
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        DialogResult dialogResult = MessageBox.Show("Khách đang thuê một phòng khác, xác nhận thuê phòng này cho khách", "Cảnh báo", MessageBoxButtons.YesNo);
                        if (dialogResult == DialogResult.Yes)
                        {
                            if (checkNhapKhachHang())
                            {
                                ...
                                {
                                    MessageBox.Show("Lỗi thuê phòng");
                                }

                            }
                            else
                                MessageBox.Show("Nhập dữ liệu khách hàng", "Thông Báo");
                            //Xoa_DuLieu();
                            NhanPhong();
                        }
                        else
                        {
                            MessageBox.Show("Hủy thuê phòng", "Thông Báo");
                        }
                    }
                    else
                    {
            ...
            {
                MessageBox.Show("Phòng đang có khách thuê");
            }
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Xác nhận nhận phòng", "Thông báo'", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
        ...
        private void lbl_NgayCS_Click(object sender, EventArgs e)
        {
