...
namespace DoAn_QL_Karaoke
{
    public partial class Frm_ChuyenPhong : Form
    {
        ...
        private void btn_XacNhan_Click(object sender, EventArgs e)
        {
            ...
            if (lbl_MaPH.Text != "")
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Phòng khách đã từng thuê");
            ...
            else MessageBox.Show("Vui lòng chọn phòng hát mới");
        ...
        public void XuLyTablePhongMoi(string matp, string maph)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn phòng hát mới");
            }
        }
